...
SaveFileDataCallback :: #type proc "c" (
	fileName: cstring,
	data: rawptr,
	bytesToWrite: c.uint,
) -> bool // FileIO: Save binary data
...
foreign lib {
	...
	Remap :: proc(value: f32, inputStart: f32, inputEnd: f32, outputStart: f32, outputEnd: f32) -> f32 --- // Remap input value within input range to output range
